...
public:
   ...
   */
    ...
    */
   Graph<E>(std::function<int(E,E)> fn);       
   ...
   */
    ...
    * unaltered. If the data item exists and the in-degree
   ...
   */
   ...
   /**
    * Determines whether there is an out-directed path between two vertices.
    * @param fromKey - search key of the originating vertex.
    * @param toKey - search key of the destination vertex.  
    * @return true on success or false on failure.
    */
   bool isPath(E fromKey, E toKey) const;
